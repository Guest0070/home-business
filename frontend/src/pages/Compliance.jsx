...
export default function Compliance({ page, setPage }) {
  ...
  function downloadExpiryPdf() {
    const month = new Date().toISOString().slice(0, 7);
    downloadApiFile(`/compliance/expiry-pdf?month=${month}`, `document-expiry-${month}.pdf`).catch((err) => setError(err.message));
  }
    ...
    <div className="space-y-4">
      <div className="report-toolbar print-hide">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="btn-primary" onClick={downloadExpiryPdf}>This Month Expiry PDF</button>
